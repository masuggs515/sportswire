...
export const revalidate = 30 // revalidate every 30s — scores change frequently

export default async function ScoresPage() {
  const supabase = await createClient()

  // Fetch: yesterday through next 3 days
  ...
  // Also grab any in_progress games that might fall outside the window (edge case)
